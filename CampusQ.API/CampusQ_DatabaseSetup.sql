...
-- Add Office column for existing installations
IF COL_LENGTH('dbo.Users','Office') IS NULL
    ALTER TABLE dbo.Users ADD Office NVARCHAR(100) NULL;
GO
...
-- Demo accounts for local/capstone testing. Change passwords before production.
IF NOT EXISTS (SELECT 1 FROM dbo.Users WHERE Username='admin')
INSERT dbo.Users(Username,PasswordHash,Salt,Role,Office,CreatedAt) VALUES
('admin','xXQN79mpEkl17b0SZJ3tG1I0CbLYvbjWnqXZNFQbKj1lWjlu','', 'Admin',NULL,SYSUTCDATETIME()),
('staff','iv3E6ig77pAkVrLNZcMd90R2hKZOOa2R3mGGypiFhF8n1iJ8','', 'Staff','Registrar',SYSUTCDATETIME()),
('cashier','QI8eZMNzTukUbW6QBIqBDuF4XVyvVgZF5Tm6M1OwXHS6sFa5','', 'Staff','Cashier',SYSUTCDATETIME()),
('admission','ZtyotTEkrm67jbB+w1/a4lB9X6Hw4ku0I0ugJ5J10hRPOLyM','', 'Staff','Admission',SYSUTCDATETIME());
GO
-- ============================================================================
